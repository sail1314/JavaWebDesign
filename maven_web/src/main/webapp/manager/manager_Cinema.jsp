                                                        ...
                                                        <div class="inbox-body">
                                                            ...
                                                            <table class="table table-inbox table-hover">
                                                                ...
                                                                <tr class="">
                                                                    ...
                                                                    <td class="view-message dont-show"><strong>电影院名</strong></td>
                                                                    <td class="view-message"><strong>地址</strong>
                                                                    </td>
                                                                    <td class="view-message inbox-small-cells"></td>
                                                                    <td class="view-message text-right"><strong></strong></td>
                                                                </tr>
                                                                <c:forEach items="${sessionScope.cinemaList}" var="cinema" >
                                                                    <tr class="">
                                                                        ...
                                                                        <td class="view-message dont-show">${cinema.name}</td>
                                                                        <td class="view-message">${cinema.address}
                                                                        </td>
                                                                        <td class="view-message inbox-small-cells"></td>
