                                                        ...
                                                        <div class="inbox-body">
                                                            ...
                                                            <table class="table table-inbox table-hover">
                                                                ...
                                                                <tr class="">
                                                                    ...
                                                                    <td class="view-message dont-show"><strong>用户名</strong></td>
                                                                    <td class="view-message"><strong>密码</strong>
                                                                    </td>
                                                                    <td class="view-message inbox-small-cells"></td>
                                                                    <td class="view-message text-right"><strong>创建日期</strong></td>
                                                                </tr>
                                                                <c:forEach items="${sessionScope.userList}" var="user1" >
                                                                    <tr class="">
                                                                        ...
                                                                        <td class="view-message dont-show">${user1.name}</td>
                                                                        <td class="view-message">${user1.password}
                                                                        </td>
                                                                        <td class="view-message inbox-small-cells"></td>
                                                                        <td class="view-message text-right"><fmt:formatDate value="${user1.createtime}" pattern="yyyy-MM-dd"/></td>
                                                                    </tr>
                                                                </c:forEach>
